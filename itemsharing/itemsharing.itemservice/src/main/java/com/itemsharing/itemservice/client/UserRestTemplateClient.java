...
public class UserRestTemplateClient {
	...
	private static final Logger LOG = LoggerFactory.getLogger(UserRestTemplateClient.class);
	
	public User getUser(String username) {
		LOG.debug("In item service.getUser: {}", UserContextHolder.getContext().getCorrelationId());
